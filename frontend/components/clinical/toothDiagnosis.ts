...
export type DiagnosisPatch = { condition?: ToothCondition | null; dentition?: "deciduous" | "permanent" | null; movement?: ToothMovement | null; rotation?: ToothRotation | null };
...
export const diagnosisActions = [
  ...
  { id: "deciduous", label: "Deciduous tooth", patch: { dentition: "deciduous" } },
...
export function britishToothLabel(tooth: string, condition?: ToothCondition | null, dentition?: DiagnosisPatch["dentition"]) {
  return (dentition === "deciduous" || condition === "deciduous") && /^[UL][RL][1-5]$/.test(tooth)
