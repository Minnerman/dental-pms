...
Baseline:
`origin/master@ae724be9a210dce349f9492a0dc5038b67391687`
...
| Backup retention policy | Repo remediated / production schedule mismatch | Minimum 30 days target is confirmed; repo count-based retention defaults and daily service template are raised to 30 backups; scheduled production backup retention configuration is not set to the accepted 30-backup model | Remediate production scheduled backup retention configuration |
