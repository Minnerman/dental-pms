...
| Restore rehearsal status | Recorded / failed | fail | Remediation and repeat non-live restore proof |
| Backup/restore sign-off | Recorded / not accepted | no | Remediated retention proof and non-live restore proof, then owner/operator sign-off |
...
- Backup/restore proof is incomplete because minimum 30-day retention proof,
  remediated non-live restore proof, and backup/restore sign-off have not been
  accepted.
...
- Rclone remote-upload and crypt scaffolding is recorded, and first encrypted
  ...
  non-live restore proof is recorded as fail.
...
- Non-live restore rehearsal/proof is recorded as fail and requires
  remediation before backup/restore sign-off.
