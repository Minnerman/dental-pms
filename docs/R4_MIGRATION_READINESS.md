...
Baseline: `master@6bb736a6288f41332faff6d4fb28768c9c6997eb`
...
1. Opening-balance guarded scratch apply design/prototype decision, no live/default writes.
   - Target: decide whether the next opening-balance step should be a guarded scratch-only apply design or narrower decision slice, and how it should handle source drift plus the `174` zero-balance component refusals.
