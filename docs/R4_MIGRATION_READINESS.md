...
Baseline: `master@03d53bcf48d410ca692a7c1d2d029cd0842b5889`
...
1. Appointment notes scale-out continuation.
   ...
   - Likely validation: deterministic cohort chunks, patients import, canonical apply/rerun, `r4_appointment_notes_parity_pack`, consolidated parity run.
...
4. All-domain charting canonical readiness report.
   - Target: produce a current-master proof summary across active charting canonical domains after selector completion.
   - Why next: PR #551 and PR #553 make deterministic selector/proof coverage consistent enough to start summarising charting readiness without hand-built selector exceptions.
...
- Appointment notes still need scale-out parity continuation; completed questionnaire and old patient notes have first combined proof recorded in PR #553.
- All-domain charting parity should be run after selector completion and before broad dry-run migration.
...
- Continue remaining note scale-out, especially `appointment_notes`, using the existing deterministic cohort and parity pattern.
