...
- 2026-05-05: Scratch-only opening-balance dry-run/report design recorded as docs/design-only.
  ...
  - Recommended next slice: backend-only opening-balance dry-run/report CLI plus tests, no writes.
...
- 2026-05-05: PR #604 merged on `master` as backend-only, pure-helper/test-only opening-balance snapshot plan helper proof.
  ...
  - Import-readiness: `finance_import_ready=false`; superseded by the scratch-only opening-balance dry-run/report design recorded above; next finance slice is backend-only opening-balance dry-run/report CLI plus tests, no writes.
- 2026-05-04: Opening-balance snapshot import design recorded as docs/design-only.
  ...
  - Future scratch proof recommendation: PR #604 completed the pure opening-balance snapshot plan helper, and the scratch-only opening-balance dry-run/report design is recorded above; the next step is backend-only opening-balance dry-run/report CLI plus tests before any scratch apply or finance import.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; superseded by PR #604's pure opening-balance snapshot plan helper proof and the scratch-only dry-run/report design recorded above; next finance slice is backend-only opening-balance dry-run/report CLI plus tests, no writes.
- 2026-05-04: Finance invoice/charge-ref source decision recorded after live cash-event staging proof.
  ...
  - Next finance slice: backend-only opening-balance dry-run/report CLI plus tests, no writes, before any finance import.
- 2026-05-04: Live SELECT-only finance cash-event staging proof completed with no tracked repo changes.
  ...
  - Superseded by the invoice/charge-ref source decision, opening-balance snapshot design, PR #604 plan helper proof, and scratch dry-run/report design recorded above; next finance slice is backend-only opening-balance dry-run/report CLI plus tests, no writes.
