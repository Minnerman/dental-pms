...
- 2026-05-09: Owner sign-off recorded for full eligible-row opening-balance validation/no-write evidence.
  ...
  - Import-readiness: `finance_import_ready=false`; guarded apply/write has not run; live finance import remains out of scope.
