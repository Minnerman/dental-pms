...
- 2026-05-07: Post-PR #615 continuity refresh and preserved-evidence scratch execution plan recorded as docs-only planning.
  ...
  - Next finance slice: only after explicit instruction, review the preserved-evidence execution package and either produce a full eligible-row artefact/bounded fixture decision or run a scratch-only preserved-evidence execution proof under this plan.
