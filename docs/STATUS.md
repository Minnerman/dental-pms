...
- 2026-05-07: Bounded synthetic scratch execution proof added for the guarded opening-balance apply CLI.
  ...
  - Next finance slice: docs/status refresh after this PR if needed, then a full eligible-row artefact/export decision or separately authorised scratch-only execution proof; no preserved-evidence apply execution has started.
- 2026-05-06: PR #614 merged on `master` as guarded scratch-only opening-balance apply CLI prototype.
  ...
  - Current limitation: the preserved dry-run report has bounded eligible samples, so this branch does not execute against the preserved `1018`-row evidence artefact; a future execution proof needs a full eligible-row artefact or a deliberately narrower scratch fixture.
