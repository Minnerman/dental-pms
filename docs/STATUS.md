...
- 2026-05-04: Finance invoice/charge-ref source decision recorded after live cash-event staging proof.
  ...
  - Next finance slice: opening-balance snapshot import design/proof before any finance import.
- 2026-05-04: Live SELECT-only finance cash-event staging proof completed with no tracked repo changes.
  ...
  - Next finance slice: payment method mapping / import-readiness decision or charge-ref / invoice source discovery decision before any finance import.
...
- 2026-05-04: Refund-allocation/charge-ref semantics decision recorded as docs/design-only in `docs/r4/R4_FINANCE_REFUND_ALLOCATION_CHARGE_REF_DECISION.md`.
  ...
  - Superseded by PR #599's merged SELECT-only cash-event staging proof tooling and the live cash-event proof evidence recorded above; next finance slice is a payment method mapping / import-readiness decision or charge-ref / invoice source discovery decision before any finance import.
- 2026-05-04: PR #596 merged on `master` as backend-only, SELECT-only cancellation/refund/allocation reconciliation proof tooling, with live SELECT-only evidence recorded.
  ...
  - Safety: R4 access was SELECT-only; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Superseded by the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, and the live cash-event proof evidence recorded above; next finance slice is a payment method mapping / import-readiness decision or charge-ref / invoice source discovery decision before any finance import.
...
- 2026-05-04: PR #593 merged on `master` as backend-only, SELECT-only opening balance reconciliation command/report tooling.
  ...
  - Superseded by the live SELECT-only opening balance proof evidence, PR #596 cancellation/refund/allocation proof evidence, the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, and the live cash-event proof evidence recorded above; next finance slice is a payment method mapping / import-readiness decision or charge-ref / invoice source discovery decision before any finance import.
