...
- 2026-05-03: PR #582 merged on `master` as backend-only, no-DB-write guarded core-promotion apply-plan prototype.
  ...
  - Next implementation slice is scratch-only CLI/runbook wiring and transcript that writes core appointments only inside an isolated scratch DB.
