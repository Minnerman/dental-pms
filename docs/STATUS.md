...
- 2026-05-04: PR #596 merged on `master` as backend-only, SELECT-only cancellation/refund/allocation reconciliation proof tooling, with live SELECT-only evidence recorded.
  ...
  - Next finance slice: refund-allocation/charge-ref semantics decision before any finance import-readiness decision.
...
- 2026-05-04: PR #593 merged on `master` as backend-only, SELECT-only opening balance reconciliation command/report tooling.
  ...
  - Superseded by the live SELECT-only opening balance proof evidence and PR #596 cancellation/refund/allocation proof evidence recorded above; next finance slice is refund-allocation/charge-ref semantics decision before any finance import-readiness decision.
