...
- 2026-05-06: Guarded scratch-only opening-balance apply design recorded as docs/design-only.
  ...
  - Recommended next slice: backend-only guarded scratch apply planning/preflight helper and tests, no execution and no DB writes.
- 2026-05-05: Opening-balance scratch mapping stack cleanup completed after the PR #609 evidence merge.
  ...
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: guarded scratch-only opening-balance apply design/proof decision, with no live/default writes and no opening-balance apply/import work without explicit instruction.
...
- 2026-05-05: PR #607 merged on `master` as backend-only, proof-report-only, no-write opening-balance dry-run/report tooling.
  ...
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Current continuity: scratch mapping stack cleanup is complete; the next finance action is a guarded scratch-only opening-balance apply design/proof decision before any apply/import work.
- 2026-05-05: Scratch-only opening-balance dry-run/report design recorded as docs/design-only.
  ...
  - Recommended next slice: superseded by PR #607's merged backend-only dry-run/report tooling; scratch-only dry-run execution evidence and stack cleanup are now complete; next finance action is a guarded scratch-only opening-balance apply design/proof decision.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-05: PR #604 merged on `master` as backend-only, pure-helper/test-only opening-balance snapshot plan helper proof.
  ...
  - Import-readiness: `finance_import_ready=false`; superseded by PR #607's merged backend-only dry-run/report tooling; scratch-only dry-run execution evidence and stack cleanup are now complete; next finance action is a guarded scratch-only opening-balance apply design/proof decision.
- 2026-05-04: Opening-balance snapshot import design recorded as docs/design-only.
  ...
  - Future scratch proof recommendation: PR #604 completed the pure opening-balance snapshot plan helper, the scratch-only opening-balance dry-run/report design is recorded above, PR #607 completed the backend-only dry-run/report tooling, the scratch-only dry-run execution evidence is complete, and the scratch mapping stack cleanup is complete. The next finance action is a guarded scratch-only opening-balance apply design/proof decision before any scratch apply or finance import.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; superseded by PR #607's merged backend-only dry-run/report tooling; scratch-only dry-run execution evidence and stack cleanup are now complete; next finance action is a guarded scratch-only opening-balance apply design/proof decision.
- 2026-05-04: Finance invoice/charge-ref source decision recorded after live cash-event staging proof.
  ...
  - Current continuity: scratch mapping stack cleanup is complete; finance import remains out of scope pending a guarded scratch-only opening-balance apply design/proof decision.
- 2026-05-04: Live SELECT-only finance cash-event staging proof completed with no tracked repo changes.
  ...
  - Superseded by the invoice/charge-ref source decision, opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, and PR #607's merged dry-run/report tooling recorded above; scratch-only dry-run execution evidence and stack cleanup are now complete; next finance action is a guarded scratch-only opening-balance apply design/proof decision.
