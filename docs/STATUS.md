...
- When development resumes: keep any preserved local operational diffs separate, review this file, `docs/R4_MIGRATION_READINESS.md`, `docs/r4/CHARTING_CANONICAL_READINESS.md`, `docs/r4/CHARTING_CANONICAL_DRYRUN_PARITY_SUMMARY.md`, and `docs/r4/R4_FINANCE_SOURCE_DISCOVERY.md`; the active-domain allowlist guard is complete as of PR #558, the `perio_plaque`/`completed_questionnaire_notes`/`old_patient_notes` live deterministic scale-out proof is complete as of PR #560, `appointment_notes` accepted-cohort closure is complete as of PR #562, the combined current-master all-domain charting canonical scratch dry-run/apply/idempotency/parity transcript is complete as of PR #566, appointment scratch-readiness evidence is complete through PR #585, R4 finance source discovery is recorded as of PR #586, the SELECT-only finance inventory command/report is merged as of PR #587, the finance classification/sign helper proof is complete as of PR #591, the opening balance reconciliation tooling is complete as of PR #593, the cancellation/refund/allocation reconciliation proof tooling and live evidence are complete as of PR #596, the cancellation/refund/allocation evidence docs are current as of PR #597, the SELECT-only cash-event staging proof tooling is merged as of PR #599, live cash-event staging proof evidence is complete as of 2026-05-04, the invoice/charge-ref source decision is recorded in `docs/r4/R4_FINANCE_INVOICE_CHARGE_REF_SOURCE_DECISION.md`, the opening-balance snapshot design is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_SNAPSHOT_DESIGN.md`, the opening-balance snapshot plan helper proof is complete as of PR #604, the scratch dry-run/report design is complete as of PR #606, the backend-only opening-balance dry-run/report tooling is complete as of PR #607, scratch-only opening-balance dry-run execution evidence is complete as of 2026-05-05, the scratch mapping stack cleanup is complete, the guarded scratch-only opening-balance apply design is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_GUARDED_APPLY_DESIGN.md`, PR #612 completed the backend-only guarded scratch apply planning/preflight helper proof, PR #614 added the guarded scratch-only opening-balance apply CLI prototype, PR #615 completed the bounded synthetic scratch execution proof without real R4 artefacts, real patient data, or live/default writes, PR #616 recorded the preserved-evidence scratch execution plan, PR #617 recorded the execution package decision, PR #618 prepared the bounded fixture package, PR #619 recorded owner approval for that exact package hash/checksum, PR #620 recorded execution-readiness verification, PR #621 recorded validation/no-write evidence without `--apply`, `--confirm`, PMS DB connection, R4 access, or finance records, PR #622 recorded owner sign-off for that no-write evidence, PR #623 recorded guarded apply/write readiness without authorising execution, PR #624 recorded the first authorised local isolated scratch/test-only guarded apply/write proof, and PR #625 recorded owner sign-off for that guarded apply/write proof evidence only.
...
- The R4 finance track has completed source discovery, SELECT-only inventory/reconciliation proof work, cash-event and opening-balance proof tooling, guarded scratch-only apply design/prototype work, bounded fixture package approval, validation/no-write evidence with owner sign-off, guarded apply/write readiness, the first local isolated scratch/test-only bounded fixture guarded apply/idempotency proof, PR #625's owner sign-off for that proof evidence, and PR #626's bounded-fixture completion summary. The full eligible-row artefact track is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PLAN.md`, with provenance/redaction governance proposed in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PROVENANCE_REDACTION_PROPOSAL.md`, owner sign-off recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PROVENANCE_REDACTION_SIGNOFF.md`, a package request/template recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST.md`, package request/template sign-off recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_SIGNOFF.md`, readiness/gap assessment recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_READINESS.md`, candidate request record recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_CANDIDATE.md`, an owner-authorised request record recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_RECORD_20260509.md`, and standing authorisation recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_STANDING_AUTHORISATION.md`. The first standing-authorised non-live package creation/access evidence is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_EVIDENCE.md`: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`, manifest `r4ob-full-eligible-20260509-000001`, manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`, package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`, eligible row count `1018`, excluded row count `15999`, and expected total `-131187.13`. That evidence slice performed R4 SELECT-only access and real non-repo artefact hashing/manifesting under the standing authorisation; it did not connect to any PMS database, run validation/no-write, run guarded apply/write, write finance records, or start finance import. Package-evidence owner sign-off is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_EVIDENCE_SIGNOFF.md` and clears the package-evidence review gate. Scratch/test-only validation/no-write evidence is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_VALIDATION_NOWRITE_EVIDENCE.md`; it ran the guarded CLI without `--apply` or `--confirm`, produced `created=0`, `updated=0`, `skipped=0`, `refused=0`, did not connect to a PMS database, did not create a SQLite scratch/test DB file, did not write rows, did not access R4, and kept `finance_import_ready=false`. Validation/no-write owner sign-off is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_VALIDATION_NOWRITE_SIGNOFF.md` and clears the validation/no-write evidence-review gate. Scratch/test-only guarded apply/write proof evidence is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_GUARDED_APPLY_EVIDENCE.md`: the first run created `1018` local isolated scratch/test `PatientLedgerEntry` rows, the second run created `0` and skipped `1018`, aggregate query verification matched row count `1018` and total `-131187.13`, and invoices, payments, staging/import rows, live/default PMS writes, actual PMS Postgres writes, R4 access, and finance import remained `0`/not used. Guarded apply/write proof owner sign-off is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_GUARDED_APPLY_SIGNOFF.md` and accepts the non-live scratch/test proof evidence only. The full eligible-row non-live pathway completion summary is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_COMPLETION_SUMMARY.md`; it states R4 remains the live/main PMS, Dental PMS is not authorised as live/main PMS by this work, and any further full eligible-row finance movement requires a separate explicit owner decision and new scoped slice. Live/default finance writes, actual PMS Postgres writes, production execution, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-11: Opening-balance import deferral result recorded.
  ...
  - Evidence packet date: 2026-05-11.
  - Responder role: Codex local operator / classification-only execution status.
  - Evidence packet: guarded finance/import process available `yes`; opening-balance/live finance import execution readiness `blocked`; opening-balance/live finance import execution result `blocked`; mapped patient target remediation status `blocked`; missing target mapping count `1017`; rows imported `0`; rows deferred/excluded `1017`; import write-state after previous failed run `no writes`; rollback required `no`; rollback executed `not required`; invoice/payment/staging import execution readiness `blocked`; invoice/payment/staging import execution result `blocked`; `finance_import_ready=false`.
  - Reason classification: owner/operator deferral decision accepted for unresolved target mappings, but a guarded mapped-only live execution scope was not safely prepared; no opening-balance import was run.
  - Blocker classification: mapped-only opening-balance execution remains blocked until patient-level target mapping or an approved target-present mapped/eligible scope is safely prepared through owner/operator handling.
  - Safety confirmations: no secrets exposed `yes`; no patient data exposed `yes`; no private paths exposed `yes`; no backup contents exposed `yes`.
  - No sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, backup filenames, Google Workspace URLs, patient data, patient-level identifiers, row values, private contacts, private infrastructure details, logs, screenshots, configs, or database output are recorded.
...
- 2026-05-10: Guarded finance import mapped-patient target blocker remediated in code.
  - Scope: guarded executor remediation and evidence-status correction only. It does not run import, connect to PMS databases, access R4, access production patient data, or expose sensitive material.
  - Write-state classification: the failed guarded opening-balance import wrote no rows because the mapped-patient target blocker was raised before ledger-row creation; rollback required `no`; rollback executed `not required`.
  - Guard remediation: mapped-patient target coverage is now checked before the write helper runs, and missing coverage blocks execution before any apply/write path.
  - Execution status: guarded finance/import process available `yes`; opening-balance/live finance import execution readiness `blocked`; opening-balance/live finance import execution result `blocked`; mapped patient target remediation status `blocked`; invoice/payment/staging import execution readiness `blocked`; invoice/payment/staging import execution result `blocked`; `finance_import_ready=false`.
  - Blocker classification: patient-level mapping remediation requires owner/operator safe handling.
  - No sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, backup filenames, Google Workspace URLs, patient data, patient-level identifiers, private contacts, private infrastructure details, logs, screenshots, configs, or database output are recorded.
...
- 2026-05-10: Retention sign-off evidence status recorded.
  ...
  - Reason classification: daily schedule is confirmed but count-based retention is less than 30. Blocker classification: minimum 30-day retention proof failed; backup/restore sign-off pending.
  - No sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, backup filenames, Google Workspace URLs, patient data, patient-level identifiers, private contacts, private infrastructure details, logs, screenshots, or database output are recorded.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; production readiness remains incomplete; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, opening-balance import, patient data import, Dental PMS live/main PMS status, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Retention and non-live restore evidence status recorded.
  ...
  - Reason classification: database restore rehearsal failed in non-live target. Blocker classification: non-live restore rehearsal failed; backup/restore sign-off not accepted.
  - No sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, patient data, patient-level identifiers, private contacts, private infrastructure details, logs, screenshots, or database output are recorded.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; production readiness remains incomplete; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, opening-balance import, patient data import, Dental PMS live/main PMS status, and invoice/payment/staging import remain unauthorised.
- 2026-05-10: First backup execution evidence status recorded.
  - Scope: evidence-status recording only. It records classification-only first backup execution status in `docs/PRODUCTION_READINESS_EXECUTION_TRACKER.md`.
  - Evidence status: first encrypted backup upload is recorded as `pass` with latest safe backup timestamp `2026-05-10T14:34:56Z`.
  - Remaining backup/restore gates: minimum 30-day retention proof remains `pending`; non-live restore rehearsal/proof remains `blocked`; backup/restore sign-off remains `pending`.
  - No sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, patient data, patient-level identifiers, private contacts, private infrastructure details, logs, screenshots, or database output are recorded.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; production readiness remains incomplete; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, opening-balance import, patient data import, and invoice/payment/staging import remain unauthorised.
- 2026-05-10: Owner/operator readiness evidence status recorded.
  - Scope: evidence-status recording only. It records classification-only owner/operator readiness status in `docs/PRODUCTION_READINESS_EXECUTION_TRACKER.md`.
  - No evidence execution or verification is recorded in docs; no sensitive material is recorded. No credentials, tokens, DSNs, private URLs, exact private paths, raw dumps, generated rclone config, OAuth material, service-account material, crypt passwords or salts, backup contents, patient data, patient-level identifiers, private contacts, private infrastructure details, R4 artefact paths, source database paths, logs, screenshots, or database output are recorded.
  - Supplied status: outside-Git rclone setup evidence `yes`; first backup execution `blocked`; latest safe backup timestamp `pending`; minimum 30-day retention proof `pending`; non-live restore rehearsal/proof `blocked`; backup/restore sign-off `pending`; data migration scope decision `yes`; patient data migration decision `approved by category`; appointments/treatments/recalls migration decision `yes`.
  - Pending/not checked/hold status: production target acceptance `pending`; user/access review `pending`; UAT/practice workflow evidence `not checked`; smoke/regression evidence `not checked`; opening-balance/live finance import decision `pending`; invoice/payment/staging import decision `pending`; monitoring/support readiness `pending`; cutover communications acceptance `pending`; rollback owner acceptance `pending`; final owner go/no-go approval `hold`.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; production readiness remains incomplete; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, opening-balance import, patient data import, and invoice/payment/staging import remain unauthorised.
- 2026-05-10: Consolidated production readiness evidence packet and final gate register added.
  - Packet: `docs/PRODUCTION_READINESS_EVIDENCE_PACKET_AND_FINAL_GATE_REGISTER.md`
  - Scope: docs-only consolidated evidence packet. It does not execute or verify evidence; access R4, real artefacts, patient data, production, PMS databases, scratch SQLite, Google Workspace, or credentials; run backup commands, restore commands, rclone, migration/validation/import commands, monitoring setup, or deployment; perform finance import, opening-balance import, invoice/payment/staging import, patient data import, or production cutover.
  - Packet content: consolidated source-document index, final gate register, copy-safe owner/operator response skeleton, final go/no-go decision template, redaction policy, and stop conditions.
  - Remaining gates: outside-Git rclone setup evidence, first backup execution evidence, latest safe backup timestamp, minimum 30-day retention proof, non-live restore rehearsal/proof, backup/restore sign-off, production target acceptance, user/access review, UAT/practice workflow evidence, smoke/regression evidence, data migration scope decision, patient data migration decision, opening-balance/live finance import decision, invoice/payment/staging import decision, appointments/treatments/recalls migration decision, monitoring/support readiness, cutover communications acceptance, rollback owner acceptance, and final go/no-go approval.
...
- 2026-05-10: Domain migration, monitoring/support, and cutover communications evidence request added.
  - Request: `docs/PRODUCTION_DOMAIN_MIGRATION_SUPPORT_CUTOVER_EVIDENCE_REQUEST.md`
  - Scope: docs-only evidence request. It does not access R4, access real artefacts, use patient data, access production, connect to any PMS database, query scratch SQLite, access Google Workspace, create or inspect credentials, run backup commands, run restore commands, run rclone, run migration/validation/import commands, run monitoring setup, run deployment commands, perform finance import, perform opening-balance import, perform invoice/payment/staging import, perform patient data import, or start production cutover.
  - Evidence requested: appointments/treatments/recalls migration decisions, charting/documents/reception/clinical/finance-view dependency decisions, monitoring/support owner acceptance, first support window, escalation route, alert/log review, cutover communications readiness, and final owner go/no-go input.
  - Remaining gates: outside-Git rclone setup evidence, first backup execution evidence, latest safe backup timestamp, minimum 30-day retention proof, non-live restore rehearsal/proof, backup/restore sign-off, production target acceptance, user/access review, UAT/practice workflow evidence, smoke/regression evidence, data migration scope decision, patient data migration decision, opening-balance/live finance import decision, invoice/payment/staging import decision, appointments/treatments/recalls migration decision, monitoring/support readiness, cutover communications acceptance, rollback owner acceptance, and final go/no-go approval.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, patient data import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Rollback/go-no-go communications plan added.
  ...
  - Planning content: role-only authority placeholders, go/no-go gates, hard no-go conditions, rollback trigger definitions, communication matrix, acceptable evidence records, and stop conditions.
  - Remaining gates: outside-Git rclone setup evidence, first backup execution evidence, latest safe backup timestamp, minimum 30-day retention proof, non-live restore rehearsal/proof, backup/restore sign-off, production target acceptance, user/access review, UAT/practice workflow evidence, rollback owner acceptance, and final go/no-go approval.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Rclone credential/setup and first-backup evidence request added.
  ...
  - Binding: the request depends on the merged rclone runner scaffold in `docs/PRODUCTION_BACKUP_RCLONE_RUNNER.md` and `ops/backup_rclone_upload.sh`.
  - Evidence requested: rclone installed yes/no, Google Workspace/Drive remote configured yes/no, rclone crypt remote configured yes/no, config and credentials stored outside Git yes/no, destination classification, folder label `Dental PMS Production Backups`, no-secrets confirmation, and later first-backup upload evidence with redacted command shape.
  - Remaining gates: outside-Git credential/setup evidence, first backup execution evidence, latest safe backup timestamp, minimum 30-day retention proof, non-live restore rehearsal, restore proof, backup/restore sign-off, and final go/no-go approval.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Production backup execution-readiness plan added.
  ...
  - Binding: the plan depends on merged rclone scaffolding from PR #655 and defines prerequisites for a later first-backup upload evidence slice.
  - Evidence plan: later evidence should record timestamp, actor/owner role, redacted command shape, source/destination classifications, upload pass/fail, crypt/encryption confirmation without secrets, backup size/checksum if safe, and no patient data or secrets committed.
  - Remaining gates: external rclone config, Google Workspace/Drive remote, rclone crypt remote, credentials outside Git, first backup execution evidence, latest safe backup timestamp, minimum 30-day retention proof, non-live restore rehearsal, restore proof, backup/restore sign-off, and final go/no-go approval.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Production backup implementation/proof prep added.
  ...
  - Supplied owner/operator inputs: Google Workspace backup label `Dental PMS Production Backups`; automated service account preferred with manual upload fallback only if automation is not yet implemented; credentials must stay outside Git in environment/secret storage; daily schedule; minimum 30 days retention; local non-live restore rehearsal target; backup and restore evidence owner `Project owner / production operator`.
  - Encryption requirement: Google Workspace/Drive storage encryption plus backup archive encryption if supported by repo helpers; if archive encryption is not supported, it remains an implementation blocker.
  - Fast path: use the supplied Google Workspace / owner-controlled online storage target, confirm direct helper support or integration need, later configure backups in an authorised slice, later run first backup, later record timestamp/integrity evidence, later run non-live restore rehearsal, and later record restore proof/sign-off.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Non-invasive production-environment evidence collection recorded.
  ...
  - Owner/operator-supplied evidence: production environment label `Dental PMS production candidate`; deployment target label `Production server / hosting environment pending verification`; production/backup/monitoring owner role `Project owner / production operator`; support contact role `Project owner`; backup schedule target daily pending verification; backup retention target minimum 30 days pending verification; restore rehearsal target classification non-live restore test only; restore rehearsal not yet performed.
  - Verified evidence: redacted frontend root availability HTTP `200`; redacted frontend health proxy HTTP `200`; redacted backend static health endpoint HTTP `200`. Owner/operator independent frontend/backend/app availability status remains not yet verified.
  - Remaining blocked evidence: deployment target verification, actual backup schedule/frequency evidence, actual backup retention evidence, latest safe backup timestamp, and restore rehearsal execution/status.
  ...
  - Owner authorisation boundary: non-invasive production readiness checks only; no database connection, database writes, live/default PMS DB writes, actual PMS Postgres writes, finance import, production cutover, R4 access, patient data access, or secret exposure is authorised.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Production-environment verification evidence request added.
  ...
  - Tracker update: `docs/PRODUCTION_READINESS_EXECUTION_TRACKER.md` now marks production environment readiness, backup readiness, and restore proof as evidence requested.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
- 2026-05-10: Production-environment backup/restore verification plan added.
  - Plan: `docs/PRODUCTION_ENV_BACKUP_RESTORE_VERIFICATION_PLAN.md`
  - Scope: docs-only planning; it does not verify production, connect to production, connect to PMS databases, access R4, access/hash/inspect real artefacts, use patient data, rerun validation/no-write, rerun guarded apply/write, create finance records, perform finance import, perform invoice/payment/staging import, or start production cutover.
  - Tracker update: `docs/PRODUCTION_READINESS_EXECUTION_TRACKER.md` now marks production environment readiness, backup readiness, and restore proof as planned / pending execution evidence.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not live/main PMS; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
...
- 2026-05-10: Final status and next-decision summary recorded for the full eligible-row opening-balance non-live pathway.
  ...
  - Bound proof values: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible/excluded rows `1018`/`15999`; expected total `-131187.13`.
  - Proof results: first run exit `0`, `created=1018`, `updated=0`, `skipped=0`, `refused=15999`; second run exit `0`, `created=0`, `updated=0`, `skipped=1018`, `refused=15999`; query verification count `1018`, total `-131187.13`, duplicate references `0`; invoice/payment/staging-import counts `0`/`0`/`0`.
  - Evidence hashes: input JSON `91bc8542c0a18aed36e71854d6e69e6a0730af930942d0562b4a4cf64089e8ac`; first output `faa1e43d6c960bf0a9a54ae3abacbbfa469eecf658ff3e2a741c5e8d19a03b42`; first stdout `0a75cf1c7bd5430c1116ac4e5ff7fb8c4b5e4413c4fa35401b85e72f461a98dd`; second output `f6aa65f54e85357c2e4d9766299079831930d6ff1ec231c133a4a12c6ee12316`; second stdout `fbd9f2fe23e1528096844298726bbf5b1d60f4eaf5b8c3de1516aa4ac027596c`; query verification `40dff20545a2ca8ac990ef077423114b95a80d441858aeb6c6910d6bcf59593c`.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not authorised as live/main PMS by this work; `finance_import_ready=false`; live/default PMS writes, actual PMS Postgres writes, production execution/cutover, live finance import, and invoice/payment/staging import remain unauthorised.
  - Next decision options: pause and keep R4 live, perform independent human/business reconciliation, create a separate docs-only production cutover/readiness plan, or defer live finance import until explicit production approval.
- 2026-05-10: Independent human/business reconciliation plan added for the signed-off full eligible-row non-live evidence.
  - Plan: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_BUSINESS_RECONCILIATION_PLAN.md`
  - Scope: docs-only planning/checklist; it does not perform reconciliation, access R4, access/hash/inspect real artefacts, use patient data, connect to PMS databases, rerun validation/no-write, rerun guarded apply/write, create finance records, perform finance import, or start production cutover.
  - Checklist covers request/manifest IDs, committed evidence hashes, eligible/excluded counts, expected total, validation/no-write results, guarded apply/write first-run and idempotency results, query count/total, duplicate references, invoice/payment/staging-import counts, and confirmation that no patient-level or raw artefact contents were committed.
  - Non-authorisation: R4 remains the live/main PMS; Dental PMS is not authorised as live/main PMS; `finance_import_ready=false`; live finance import, production readiness/cutover, live/default PMS writes, actual PMS Postgres writes, and invoice/payment/staging import remain unauthorised.
  - Next decision options: pause and keep R4 live, complete manual/business reconciliation and record later docs-only sign-off, create a separate docs-only production cutover/readiness plan, or defer live finance import until explicit production approval.
- 2026-05-09: Owner sign-off recorded for full eligible-row opening-balance guarded apply/write proof evidence.
  - Sign-off record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_GUARDED_APPLY_SIGNOFF.md`
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_GUARDED_APPLY_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  - Signed-off values: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible row count `1018`; excluded row count `15999`; expected total `-131187.13`.
  - Proof facts accepted: first run exit `0`, `created=1018`, `updated=0`, `skipped=0`, `refused=15999`; second run exit `0`, `created=0`, `updated=0`, `skipped=1018`, `refused=15999`; query verification count `1018`, total `-131187.13`, duplicate references `0`; invoice/payment/staging-import counts `0`/`0`/`0`.
  - Evidence hashes accepted: input JSON `91bc8542c0a18aed36e71854d6e69e6a0730af930942d0562b4a4cf64089e8ac`; first output `faa1e43d6c960bf0a9a54ae3abacbbfa469eecf658ff3e2a741c5e8d19a03b42`; first stdout `0a75cf1c7bd5430c1116ac4e5ff7fb8c4b5e4413c4fa35401b85e72f461a98dd`; second output `f6aa65f54e85357c2e4d9766299079831930d6ff1ec231c133a4a12c6ee12316`; second stdout `fbd9f2fe23e1528096844298726bbf5b1d60f4eaf5b8c3de1516aa4ac027596c`; query verification `40dff20545a2ca8ac990ef077423114b95a80d441858aeb6c6910d6bcf59593c`.
  - Scope: sign-off accepts the guarded apply/write proof evidence as a non-live scratch/test proof only.
  - Non-authorisation: this sign-off does not authorise live/default PMS writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, raw artefact commits, or patient-level committed contents.
  - Import-readiness: `finance_import_ready=false`; migration/import is not complete, production readiness is not claimed, and live finance import remains out of scope.
- 2026-05-09: Full eligible-row opening-balance scratch/test-only guarded apply/write proof evidence recorded.
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_GUARDED_APPLY_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  - Identity checks: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible row count `1018`; excluded row count `15999`; expected total `-131187.13`; repo SHA `0436a4ed39211e5ad63b8c77c876dfa41097fab1`.
  - Guarded command: `--apply` used; exact `--confirm SCRATCH_OPENING_BALANCE_APPLY` used; `--actor-id` used; target was local isolated SQLite scratch/test only, not live/default and not actual PMS Postgres.
  - First run: exit `0`, `created=1018`, `updated=0`, `skipped=0`, `refused=15999`, ledger total `-131187.13`, invoice count `0`, payment count `0`, staging/import count `0`, and `finance_import_ready=false`.
  - Second run: exit `0`, `created=0`, `updated=0`, `skipped=1018`, `refused=15999`; duplicate protection passed and aggregate query verification matched count `1018`, unique manifest-scoped references `1018`, duplicate references `0`, and total `-131187.13`.
  - Evidence hashes: transient apply input `91bc8542c0a18aed36e71854d6e69e6a0730af930942d0562b4a4cf64089e8ac`; first output `faa1e43d6c960bf0a9a54ae3abacbbfa469eecf658ff3e2a741c5e8d19a03b42`; first stdout `0a75cf1c7bd5430c1116ac4e5ff7fb8c4b5e4413c4fa35401b85e72f461a98dd`; second output `f6aa65f54e85357c2e4d9766299079831930d6ff1ec231c133a4a12c6ee12316`; second stdout `fbd9f2fe23e1528096844298726bbf5b1d60f4eaf5b8c3de1516aa4ac027596c`; query verification `40dff20545a2ca8ac990ef077423114b95a80d441858aeb6c6910d6bcf59593c`.
  - Safety: no R4 access; real artefact access and real patient data use were limited to authorised non-repo identity checks and local scratch/test proof input handling; no patient-level contents, raw artefact contents, exact storage paths, patient codes, row-level ledger references, unredacted DSNs, or secrets were committed.
  - Non-authorisation: this evidence does not authorise live/default PMS writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, raw artefact commits, or patient-level committed contents.
  - Subsequent owner sign-off and final non-live pathway status are recorded above; live finance import remains unauthorised.
- 2026-05-09: Owner sign-off recorded for full eligible-row opening-balance validation/no-write evidence.
  - Sign-off record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_VALIDATION_NOWRITE_SIGNOFF.md`
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_VALIDATION_NOWRITE_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  - Signed-off values: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible row count `1018`; excluded row count `15999`; expected total `-131187.13`; validation input JSON SHA256 `29f42c0c8e8396cea0eba5e5a76fb37dceb2f24b5ce4a8c001e97a52239ed43b`; validation output JSON SHA256 `8f5831649d96b19881c330aa0798da40b6fb851bc6acf72ec6e914f70a6a273d`; source aggregate check JSON SHA256 `31be7121c2c753c665b7a43529a203bed085e5b76309b602198be586d9b0577f`.
  - Scope: sign-off is limited to validation/no-write evidence review and clears the next non-live gate for scratch/test-only guarded apply/write proof.
  - Non-authorisation: this sign-off does not authorise live/default PMS writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, raw artefact commits, or patient-level committed contents.
  - Import-readiness: `finance_import_ready=false`; at sign-off time guarded apply/write had not run; subsequent scratch/test-only proof evidence is recorded above; live finance import remains out of scope.
- 2026-05-09: Full eligible-row opening-balance scratch/test-only validation/no-write evidence recorded.
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_VALIDATION_NOWRITE_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  - Identity checks: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible row count `1018`; excluded row count `15999`; expected total `-131187.13`; repo SHA `f299243dbe0d54e759a1831f9caa2e562b48d182`.
  - Validation result: guarded CLI exited `0` in validation/no-write mode with `apply_requested=false`, `created=0`, `updated=0`, `skipped=0`, `refused=0`, and `finance_import_ready=false`.
  - Evidence hashes: transient no-write input `29f42c0c8e8396cea0eba5e5a76fb37dceb2f24b5ce4a8c001e97a52239ed43b`; CLI validation output `8f5831649d96b19881c330aa0798da40b6fb851bc6acf72ec6e914f70a6a273d`; source aggregate check `31be7121c2c753c665b7a43529a203bed085e5b76309b602198be586d9b0577f`.
  - Safety: no R4 access occurred in this validation slice; real artefact access was limited to non-repo identity hashing, manifest/package summary parsing, and aggregate count/total validation; no patient-level contents, raw artefact contents, exact storage paths, unredacted DSNs, or secrets were committed.
  - Non-authorisation: this evidence does not authorise guarded apply/write, passing `--apply`, passing `--confirm`, PMS DB writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, or full migration/import completion.
- 2026-05-09: Owner sign-off recorded for full eligible-row opening-balance artefact package evidence.
  - Sign-off record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_EVIDENCE_SIGNOFF.md`
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  - Signed-off values: source artefact SHA256 `357400cf5c1a53a8b34b6b0d7589b57b76754603946282d794b1881f71f75755`; manifest checksum `3b902805b138700441ba99b15eb2dadef34829fa3d3544383c0e387142f5a51b`; package summary SHA256 `25c15e9ebcd018c108dfca758ce04d6463f0520af0c918c4ee97f7cfc8aeb872`; eligible row count `1018`; excluded row count `15999`; expected total `-131187.13`.
  - Scope: sign-off is limited to package-evidence review and clears the next non-live gate for scratch/test-only validation/no-write.
  - Non-authorisation: this sign-off does not authorise guarded apply/write, live/default PMS writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, raw artefact commits, or patient-level committed contents.
  - Import-readiness: `finance_import_ready=false`; live finance import remains out of scope.
- 2026-05-09: First standing-authorised non-live full eligible-row opening-balance artefact package evidence recorded.
  - Evidence summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_EVIDENCE.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Manifest ID: `r4ob-full-eligible-20260509-000001`
  ...
  - Counts and total: `17017` PatientStats rows considered; `1018` eligible rows; `15999` excluded/no-op rows; expected total `-131187.13`.
  - Storage: source artefact and manifest are outside the repo in access-controlled storage; raw artefact contents and patient-level rows are not committed.
  - Safety: R4 SELECT-only access and real artefact access occurred only for the approved package request; no PMS DB connection, local scratch SQLite access, validation/no-write, guarded apply/write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, or production execution occurred.
  - Import-readiness: `finance_import_ready=false`; live finance import remains out of scope.
- 2026-05-09: Standing owner authorisation recorded for the non-live full eligible-row opening-balance artefact package pathway.
  - Standing authorisation: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_STANDING_AUTHORISATION.md`
  - Request record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_RECORD_20260509.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Scope: standing authorisation is limited to non-live staged work for the approved request, including future artefact creation/access from R4, approved non-repo storage, artefact hashing, manifest/checksum/count/total creation, redacted evidence summaries, scratch/test-only validation/no-write, scratch/test-only guarded apply/write proof, idempotency proof, and docs/evidence PRs, all subject to documented guards and stop conditions.
  - This PR/slice: docs-only; it does not perform R4 access, real artefact access/creation/hash/storage/validation/execution, PMS DB connection, validation/no-write, guarded apply/write, or finance import.
  - Still unauthorised: live/default PMS DB writes, actual PMS Postgres writes, production execution, live finance import, invoice/payment/staging import, committing raw R4 artefact contents, and committing patient names, DOBs, addresses, phone numbers, emails, clinical details, or unredacted DSNs/secrets.
  - Import-readiness: `finance_import_ready=false`; live finance import remains out of scope.
- 2026-05-09: Owner-authorised full eligible-row opening-balance artefact package request record added as docs-only governance.
  - Request record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_RECORD_20260509.md`
  - Request ID: `r4ob-full-eligible-request-20260509-000001`
  - Scope: owner-authorised request metadata only; this is not an artefact creation/access approval.
  - Remaining future gates: artefact creation/access authorisation, artefact storage approval, manifest/checksum/expected-total approval, validation/no-write authorisation, validation/no-write evidence sign-off, guarded apply/write readiness check, guarded apply/write authorisation, guarded apply/write evidence sign-off, and any live import decision as a separate unauthorised gate.
  - Non-authorisation: this record does not authorise R4 access, real artefact access, artefact creation/copying/hashing/storage/validation/execution, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, production execution, or full eligible-row artefact execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-09: Owner sign-off recorded for the full eligible-row opening-balance artefact package request/template.
  - Sign-off record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST_SIGNOFF.md`
  - Request/template: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST.md`
  - Scope: sign-off is limited to accepting the package request/template as the required structure for any future full eligible-row artefact package request.
  - Non-authorisation: this sign-off does not authorise R4 access, real artefact access, artefact creation/copying/hashing/storage/validation/execution, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, production execution, or full eligible-row artefact execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-09: Full eligible-row opening-balance artefact package request/template recorded as docs-only planning.
  - Request/template: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PACKAGE_REQUEST.md`
  - Scope: request/proposal/template only; it does not create, access, inspect, copy, hash, store, validate, or execute a real full eligible-row artefact.
  - Required request fields: request ID, owners/approvers, source system, extraction purpose/method/effective date, creation timestamp, safe operator/actor identifier, storage policy, manifest ID, source artefact SHA256, manifest checksum, expected total, eligible/excluded row counts, repo SHA, tool/CLI version or commit SHA, inclusion/exclusion rules, zero/negative balance policy, duplicate handling, currency/decimal policy, redaction/storage approval, scratch/test target approval, validation/no-write authorisation, and guarded apply/write authorisation.
  - Non-authorisation: this request/template does not authorise R4 access, real artefact access, artefact creation/copying/hashing/storage/validation/execution, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, production execution, or full eligible-row artefact execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-09: Owner sign-off recorded for the full eligible-row opening-balance artefact provenance/redaction proposal.
  - Sign-off record: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PROVENANCE_REDACTION_SIGNOFF.md`
  - Proposal: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PROVENANCE_REDACTION_PROPOSAL.md`
  - Scope: sign-off is limited to accepting the proposal as the governance framework for any future full eligible-row artefact package.
  - Non-authorisation: this sign-off does not authorise R4 access, real artefact access, artefact creation/copying/hashing/storage/validation/execution, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, production execution, or full eligible-row artefact execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-08: Full eligible-row opening-balance artefact provenance/redaction proposal added as docs-only planning.
  - Proposal: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PROVENANCE_REDACTION_PROPOSAL.md`
  - Scope: proposal only; no full eligible-row artefact was created, accessed, inspected, copied, hashed, stored, validated, or executed.
  - Governance defined: artefact owner, approving role, source/provenance, extraction purpose/method/timestamp, naming conventions, source artefact hash, manifest checksum, repo SHA, tool/CLI version or commit SHA, expected total, eligible/excluded row counts, inclusion/exclusion rules, zero/negative balance policy, duplicate handling, currency/decimal precision, scratch/test target classification, and redacted command shape.
  - Redaction/storage: no full artefact contents, patient names, DOBs, addresses, phone numbers, emails, clinical details, unredacted DSNs/secrets, or production/live-looking target details in committed docs; storage must be approved, access-controlled, hashable, and immutable for the evidence window.
  - Non-authorisation: this proposal does not authorise R4 access, real artefact access, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, full eligible-row artefact execution, or production execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-08: Full eligible-row opening-balance artefact planning track started as docs-only planning.
  - Plan: `docs/r4/R4_FINANCE_OPENING_BALANCE_FULL_ELIGIBLE_ARTEFACT_PLAN.md`
  - Scope: planning only; no full eligible-row artefact was created, accessed, inspected, copied, hashed, stored, validated, or executed.
  - Gates defined: provenance approval, redaction/storage approval, manifest/checksum/expected-total approval, scratch/test target approval, validation/no-write authorisation, evidence review/sign-off, guarded apply/write readiness, separate guarded apply/write authorisation, proof evidence review/sign-off, and a post-proof pause/revise/rehearsal decision.
  - Required future evidence: validation/no-write evidence and guarded apply/write evidence must bind to manifest ID, manifest checksum, source artefact hash, eligible row count, expected total, target classification, repo SHA, redacted command shape, counts, evidence paths, and evidence hashes.
  - Non-authorisation: this planning doc does not authorise R4 access, real artefact access, real patient data use, PMS DB connection, guarded scratch apply, CLI validation/no-write, live/default PMS writes, actual PMS Postgres writes, finance import, invoice/payment/staging import, full eligible-row artefact execution, or production execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-08: Final bounded opening-balance fixture pathway status recorded after PR #625.
  - Completion summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_COMPLETION_SUMMARY.md`
  - Status: bounded-fixture scratch/test pathway is complete through signed-off guarded apply/write proof evidence for manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Bounds: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`; first apply evidence `802d4ca94762e060037b97dc68bdd08ad40d17541f04493378f5a0125a567837`; second idempotency evidence `e83a3faf7a6b22045d11a98559f342618d81a192841079864d0e2688cdfa5e2b`; local query verification evidence `db8846ca82489a67a0979a5524fbb1e8f0cefe6d36db12630180e13293b762f0`.
  - Non-authorisation: this status refresh does not authorise live/default PMS writes, actual PMS Postgres writes, R4 access, real artefact access, real patient data, finance import, invoice/payment/staging import, full eligible-row artefact execution, or production execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance options: pause after bounded-fixture pathway completion, final owner status sign-off if desired, or a separate full eligible-row artefact planning track; do not proceed to live import.
- 2026-05-08: Owner sign-off recorded for bounded opening-balance fixture guarded apply/write proof evidence.
  - Sign-off record: `docs/r4/fixtures/opening_balance_bounded_fixture/GUARDED_APPLY_EVIDENCE_SIGNOFF_20260508.md`
  - Evidence report: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_GUARDED_APPLY_EVIDENCE.md`
  - Scope: sign-off is limited to guarded apply/write proof evidence for manifest `ob-bounded-fixture-20260507-000001`, fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`, manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`, row count `3`, eligible count `3`, and expected total `7.35`.
  - Bound evidence hashes: first apply JSON `802d4ca94762e060037b97dc68bdd08ad40d17541f04493378f5a0125a567837`; second idempotency JSON `e83a3faf7a6b22045d11a98559f342618d81a192841079864d0e2688cdfa5e2b`; local query verification JSON `db8846ca82489a67a0979a5524fbb1e8f0cefe6d36db12630180e13293b762f0`.
  - Non-authorisation: this sign-off does not authorise live/default PMS writes, actual PMS Postgres writes, R4 access, real artefact access, real patient data, finance import, invoice/payment/staging import, production execution, or full eligible-row artefact execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-08: Bounded opening-balance fixture guarded apply/write proof recorded.
  - Evidence report: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_GUARDED_APPLY_EVIDENCE.md`
  - Approved package: manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Hash validation: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`.
  - Target classification: local isolated SQLite scratch/test only; no live/default PMS DB or actual PMS Postgres was used.
  - First run: guarded apply exited `0` with `apply_requested=true`, `created=3`, `updated=0`, `skipped=0`, `refused=0`; ledger count moved from `0` to `3`, invoices/payments stayed `0`, and `finance_import_ready=false`.
  - Second run: idempotency pass exited `0` with `created=0`, `updated=0`, `skipped=3`, `refused=0`; ledger count stayed `3` with three unique manifest-scoped references and total `7.35`.
  - Evidence hashes: first output `802d4ca94762e060037b97dc68bdd08ad40d17541f04493378f5a0125a567837`; second output `e83a3faf7a6b22045d11a98559f342618d81a192841079864d0e2688cdfa5e2b`; local query verification `db8846ca82489a67a0979a5524fbb1e8f0cefe6d36db12630180e13293b762f0`.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no live/default PMS writes occurred; no finance import, invoice import, payment import, or staging import started.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope and this proof is not production readiness.
  - Next finance slice: review this guarded apply/idempotency evidence before deciding whether any further scratch/test-only finance proof is needed.
- 2026-05-08: Bounded opening-balance fixture guarded apply/write readiness check recorded.
  - Readiness report: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_GUARDED_APPLY_READINESS.md`
  - Readiness status: prerequisites are present for considering a future separately authorised scratch/test-only guarded apply/write slice against manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Bound evidence: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`; validation/no-write evidence SHA256 `c053f6514b6a9109c60561be5ae7485d81399d43cfc58bcbe58f915b5c880840`; sign-off record `docs/r4/fixtures/opening_balance_bounded_fixture/VALIDATION_NOWRITE_SIGNOFF_20260508.md`.
  - Future guards: a later authorised apply/write proof must use a scratch/test target, `--apply`, exact `--confirm SCRATCH_OPENING_BALANCE_APPLY`, `--actor-id`, fixture/hash/total/count/repo guards, redacted command evidence, and a second-run idempotency proof.
  - Non-authorisation: this readiness check does not authorise guarded apply/write and did not run guarded scratch apply, rerun CLI validation/no-write, connect to any PMS database, create ledger rows, access R4, access a real artefact, use real patient data, or start finance import.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: only after explicit separate instruction, authorise and run a scratch/test-only guarded apply/write proof with all guards rechecked.
...
- 2026-05-08: Bounded opening-balance fixture validation/no-write evidence recorded.
  ...
  - Approved package: manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Hash validation: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`.
  - Validation result: CLI validation/no-write exited `0` with `apply_requested=false`, `created=0`, `updated=0`, `skipped=0`, `refused=0`, `finance_counts.before=null`, and `finance_counts.after=null`.
  - Target classification: local SQLite scratch/test URL string only; no PMS DB connection occurred and the SQLite scratch/test database file was not created.
  - Guards: `--apply` was not used; `--confirm` was not used; the preflight plan stayed fail-closed for apply with `missing_confirmation_token`.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no PMS DB writes occurred; no actual PMS Postgres was used; no ledger rows or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: review this validation/no-write evidence before any separate decision to authorise guarded scratch/test apply/write.
- 2026-05-08: Bounded opening-balance fixture execution-readiness verified as docs-only.
  - Readiness report: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_EXECUTION_READINESS.md`
  - Readiness status: ready for a later separately authorised scratch/test-only preserved-evidence execution slice, starting with validation/no-write.
  - Approved package: manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Hash validation: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`.
  - Guard inspection: CLI defaults to validation/no-write, apply requires `--apply`, `--confirm SCRATCH_OPENING_BALANCE_APPLY`, and `--actor-id`, non-scratch/live-looking targets are refused, identity guards are supported, and manifest-scoped idempotency uses `R4OB:<manifest_id>:<PatientCode>` references.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no PMS DB connection occurred; no guarded scratch apply or CLI validation ran; no PMS DB writes or finance records occurred.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: only after explicit instruction, run the scratch/test-only execution slice with validation/no-write first; do not run guarded apply unless that future slice separately authorises execution and all guards pass.
- 2026-05-07: Owner approval recorded for the bounded opening-balance fixture package as docs-only evidence.
  - Approval record: `docs/r4/fixtures/opening_balance_bounded_fixture/APPROVAL_RECORD_20260507.md`
  - Approved package: manifest `ob-bounded-fixture-20260507-000001`, row count `3`, eligible count `3`, expected total `7.35`.
  - Approved hashes: fixture SHA256 `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256 `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`.
  - Scope: approval is limited to future scratch/test-only preserved-evidence execution, with validation/no-write first; guarded apply remains a later separately authorised execution step.
  - Hash preservation: `fixture.json` and `manifest.json` were not changed, so the approved fixture/source hash and manifest checksum remain valid.
  - Safety: this approval does not authorise live/default PMS writes, actual PMS Postgres writes, R4 access, real R4 artefact access, real patient data, finance import, invoice/payment/staging import, or production execution.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: only after explicit instruction, run a scratch/test-only execution slice with validation/no-write first; do not run guarded apply unless that future slice separately authorises execution and all guards pass.
- 2026-05-07: Candidate opening-balance bounded fixture package prepared as docs/fixture-only planning.
  - Package summary: `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_PACKAGE.md`
  - Package directory: `docs/r4/fixtures/opening_balance_bounded_fixture/`
  - Manifest ID: `ob-bounded-fixture-20260507-000001`; row count `3`; eligible count `3`; expected total `7.35`.
  - Fixture SHA256: `2afabfcb903b0f4e5a94702ae93b7752e9309e30116a4d01e1f55ec84465b53d`; manifest SHA256: `66cc1c7ac16a4e677dfea6994cef86a5b7c496a00fbfec10336fa7641d98bb67`.
  - Package status after the owner approval record above: approved for future scratch/test-only package use; it still does not authorise execution by itself.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no PMS DB writes occurred; no guarded scratch apply execution occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: superseded by the owner approval record above; do not run guarded scratch apply until a future scratch/test-only execution slice explicitly authorises execution.
- 2026-05-07: Opening-balance execution package decision recorded as docs-only planning.
  - Decision doc: `docs/r4/R4_FINANCE_OPENING_BALANCE_EXECUTION_PACKAGE_DECISION.md`
  - Decision: recommend Option B, approved bounded fixture, for the next explicitly authorised scratch/test-only execution proof because no approved complete eligible-row artefact package exists yet.
  - Option A, complete eligible-row artefact, remains the stronger later rehearsal path but is blocked until provenance, redaction, storage, manifest checksum, source/report/mapping hashes, and owner approval are established.
  - Option B acceptance criteria: approved bounded row set, stable manifest ID, manifest checksum, fixture/source hash, expected total, eligible count, repo SHAs, inclusion/exclusion rules, complete eligible rows for the bounded set, scratch/test target classification, redacted command shape, validation/no-write first, and guarded write flags only for a later apply step.
  - Rejection/stop conditions: missing checksum/total/count/repo SHA, unredacted DSN or secret, committed patient-sensitive data, non-scratch or live-looking target, invoice/payment/staging intent, ambiguous rollback/cleanup, idempotency failure, or any finance import request.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no PMS DB writes occurred; no guarded scratch apply execution occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: only after explicit instruction, prepare the Option B approved bounded fixture package for scratch/test-only execution; do not run guarded scratch apply until that package is reviewed and approved.
- 2026-05-07: Post-PR #615 continuity refresh and preserved-evidence scratch execution plan recorded as docs-only planning.
  - Plan doc: `docs/r4/R4_FINANCE_OPENING_BALANCE_PRESERVED_EVIDENCE_SCRATCH_EXECUTION_PLAN.md`
  - Scope: future explicitly authorised preserved-evidence scratch/test execution only; this slice does not execute guarded scratch apply, access R4, read a real R4 artefact, connect to a real PMS DB, or write finance records.
  - Required future guards: accepted dry-run artefact provenance, manifest/report/source hashes, expected total, eligible count, repo SHA, scratch/test target classification, validation/no-write first, then `--apply`, `--confirm SCRATCH_OPENING_BALANCE_APPLY`, and `--actor-id` only for an isolated scratch/test target.
  - Evidence plan: capture validation/apply/idempotency reports, stdout/stderr/exit codes, before/after finance counts, created/skipped/refused counts, redacted command shape, target classification, manifest ID, hashes, repo SHAs, timestamp, and cleanup or rollback result without committing full artefacts or patient-sensitive data.
  - Stop conditions: any R4 access requirement, real PMS DB requirement, default/live/production-looking target, incomplete eligible-row artefact, checksum/total/count/repo mismatch, unacknowledged source drift, would-write component mismatch, existing mismatched markers, invoice/payment/staging intent, broad rollback, or sensitive output.
  - Safety: no R4 access occurred; no real R4 artefact was opened; no real patient data was used; no PMS DB writes occurred; no guarded scratch apply execution occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: superseded by the execution package decision above; no preserved-evidence apply execution has started.
- 2026-05-07: Bounded synthetic scratch execution proof added for the guarded opening-balance apply CLI.
  - Exact slice implemented:
    - added `backend/tests/r4_import/test_opening_balance_guarded_scratch_apply_synthetic_proof.py`
    - added `docs/r4/R4_FINANCE_OPENING_BALANCE_SYNTHETIC_SCRATCH_PROOF.md`
    - updated `docs/r4/R4_FINANCE_OPENING_BALANCE_GUARDED_APPLY_DESIGN.md`
  - Proof data: generated synthetic non-R4 rows only, using `TEST-R4OB-001` and `TEST-R4OB-002` codes with no real patient data and no committed R4 artefact.
  - Proof summary: manifest `ob-synthetic-20260507-000001`, synthetic eligible rows `2`, expected total `7.34`, first guarded apply `created=2`, second guarded apply `skipped=2`, invoices/payments stayed `0`, validation/no-write mode did not create the SQLite scratch DB file, and non-scratch target plus identity mismatches were refused.
  - Validation: py_compile for the synthetic proof test passed; targeted synthetic proof test passed (`1 passed`); guarded CLI plus synthetic proof tests passed (`10 passed`); adjacent opening-balance apply-plan, snapshot-plan, and dry-run tests passed with the new proof (`62 passed`).
  - Safety: no R4 access occurred; no real R4 artefact was used; no real PMS database connection occurred; no live/default PMS DB writes occurred; tests wrote only to local SQLite scratch-test databases under pytest `tmp_path`; no live finance records were created or changed; no finance import or staging models were added.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: superseded by the preserved-evidence scratch execution plan above; no preserved-evidence apply execution has started.
- 2026-05-06: PR #614 merged on `master` as guarded scratch-only opening-balance apply CLI prototype.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/opening_balance_snapshot_guarded_apply.py`
    - added `backend/app/scripts/r4_opening_balance_guarded_scratch_apply.py`
    - added `backend/tests/r4_import/test_opening_balance_guarded_scratch_apply_cli.py`
    - updated `docs/r4/R4_FINANCE_OPENING_BALANCE_GUARDED_APPLY_DESIGN.md`
  - Prototype scope: consumes the existing dry-run report JSON shape, defaults to validation/no-write mode, refuses default/live/production-looking targets before opening a session, requires `--apply`, `--confirm SCRATCH_OPENING_BALANCE_APPLY`, and `--actor-id` for scratch writes, and writes only manifest-scoped `PatientLedgerEntry` adjustment rows in an explicit scratch/test target.
  - Guard coverage: report SHA256, optional expected total/eligible/repo-SHA checks, PR #612 preflight integration, scratch/test DB target check, source-drift acknowledgement, full eligible-row artefact requirement for apply, idempotent rerun by exact `R4OB:<manifest_id>:<PatientCode>` reference, and invoice/payment/staging/balance-mutation refusal.
  - Current limitation: the preserved dry-run report has bounded eligible samples, so PR #614 did not execute against the preserved `1018`-row evidence artefact; a future execution proof needs a full eligible-row artefact or a deliberately narrower scratch fixture.
  - Validation: temporary venv py_compile passed; focused CLI/prototype tests passed (`9 passed`); adjacent opening-balance apply-plan, snapshot-plan, and dry-run tests passed with the new tests (`61 passed`).
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS live/default DB writes occurred; tests wrote only to local SQLite scratch-test databases under pytest `tmp_path`; no live finance records were created or changed; no finance import or staging models were added.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: superseded by the bounded synthetic scratch execution proof above; no preserved-evidence apply execution has started.
- 2026-05-06: PR #612 merged on `master` as backend-only, pure-helper/test-only guarded opening-balance apply planning/preflight proof.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/opening_balance_snapshot_apply_plan.py`
    - added `backend/tests/r4_import/test_opening_balance_snapshot_apply_plan.py`
  - Helper scope: deterministic planning/preflight result only; no DB session, no CLI, no importer/apply behaviour change, no apply execution, and no finance import.
  - Preflight decisions: DB target, confirmation token, dry-run report, eligibility, mapping, before-counts, write plan, idempotency, rollback, and reason codes.
  - Safety gates: missing target refused, default `dental_pms` refused, only target names containing `scratch` or `test` allowed, exact `SCRATCH_OPENING_BALANCE_APPLY` token required, `dry_run=true`, `import_ready=false`, `manifest.no_write=true`, `manifest.apply_mode=false`, repo SHA present, eligible count present, full non-zero mapping coverage, and unmapped non-zero count `0`.
  - Write plan: plans only `patient_ledger_entry_adjustment`, keeps `finance_import_ready=false`, refuses invoice/payment/staging/balance-mutation intent, supports full existing-manifest skip planning, fails closed on partial/mismatched duplicate state, keeps rollback manifest-scoped, and refuses broad ledger deletion.
  - Validation: temporary venv py_compile passed; focused apply-plan tests passed (`20 passed`); existing opening-balance snapshot plan tests passed (`19 passed`); existing opening-balance dry-run tests passed (`13 passed`); GitHub CI passed for backend, frontend, docker-build, recalls-api, playwright-parity, and playwright-smoke.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance records were created or changed; no finance staging models were added.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Current continuity: guarded scratch apply planning/preflight helper proof is complete and merged; guarded scratch apply CLI design/prototype should start only after explicit instruction, and no apply execution has started.
- 2026-05-06: Guarded scratch-only opening-balance apply design recorded as docs/design-only.
  - Design doc: `docs/r4/R4_FINANCE_OPENING_BALANCE_GUARDED_APPLY_DESIGN.md`
  - Decision: a future scratch apply prototype should use existing `PatientLedgerEntry` rows with `entry_type=adjustment`, strict `R4OB:<manifest_id>:<PatientCode>` references, `related_invoice_id=NULL`, `method=NULL`, exact `PatientStats.Balance` pence values, and manifest-scoped metadata.
  - Scope: scratch-only opening-balance mechanism proof; not historical invoice import, not normal payment import, and not full finance import.
  - Required gates: scratch/test DB only, default/live DB refusal before session creation, explicit `SCRATCH_OPENING_BALANCE_APPLY` confirmation, accepted dry-run report, source/mapping/report hashes, mapping coverage for all non-zero candidates, finance before-counts, duplicate marker refusal, idempotency keys, and manifest-scoped rollback design.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Recommended next slice: superseded by PR #612's backend-only guarded scratch apply planning/preflight helper proof; guarded scratch apply CLI design/prototype should start only after explicit instruction, with no finance import.
- 2026-05-05: Opening-balance scratch mapping stack cleanup completed after the PR #609 evidence merge.
  - Scratch project: `dentalpms-obmap-20260505-082233`; scratch DB: `dental_pms_opening_balance_mapping_scratch`.
  - Cleanup result: scratch containers `none`; scratch volumes `none`.
  - Preserved artefacts: `/home/amir/dental-pms-opening-balance-dryrun-execution/.run/opening_balance_snapshot_dryrun_mapping_20260505_082233/`
  - Default/main `dental-pms` stack remained untouched.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Next finance slice: superseded by PR #611's guarded apply design and PR #612's planning/preflight helper proof; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-05: Scratch-only opening-balance dry-run execution evidence completed with no tracked repo changes.
  - Evidence worktree: `/home/amir/dental-pms-opening-balance-dryrun-execution`
  - PatientStats source artefact: `/home/amir/dental-pms-opening-balance-dryrun-execution/.run/opening_balance_snapshot_dryrun_20260505_080845/patient_stats_rows.json`
  - Dry-run/mapping artefacts: `/home/amir/dental-pms-opening-balance-dryrun-execution/.run/opening_balance_snapshot_dryrun_mapping_20260505_082233/`
  - Key artefacts: `scratch_patient_mapping.json`, `mapping_coverage_summary.json`, `opening_balance_snapshot_dryrun_report.json`, `opening_balance_snapshot_dryrun.stdout`, `opening_balance_snapshot_dryrun.stderr`, `opening_balance_snapshot_dryrun_exit_code.txt`, `patients_import_stats.json`, and `patients_mapping_quality.json`.
  - Scratch mapping evidence: `COMPOSE_PROJECT_NAME=dentalpms-obmap-20260505-082233`, scratch DB `dental_pms_opening_balance_mapping_scratch`, Postgres port `5579`; scratch PMS writes were limited to migrations, a minimal admin actor, patients, and `r4_patient_mappings`.
  - Mapping coverage: `17012` mapping rows, `1018/1018` non-zero `PatientStats` candidates mapped, `0` unmapped non-zero candidates.
  - Dry-run result: command exited `0`, JSON parsed, `dry_run=true`, `import_ready=false`, `finance_import_ready=false`, `manifest.no_write=true`, `apply_mode=false`.
  - Dry-run summary: source rows `17012`, non-zero rows `1018`, final dry-run no-op zero rows `15820`, total balance `-131742.13`; eligibility was eligible `1018`, no-op `15820`, component mismatch `174`, all other refusal classes `0`.
  - Sign and aged-debt summary: positive `291`, negative `727`, zero `15994`; proof-only `increase_debt=291`, `decrease_debt_or_credit=727`, `no_action=15994`; aged debt present `126`, balance without aged debt `892`, aged debt with zero balance `0`, total aged debt `10329.82`.
  - Component/refusal summary: component pass `16838`, mismatch `174`, not evaluated `0`; refusal reason `component_amount_missing_or_invalid=174`. The mismatches were zero-balance rows with missing/null component fields, so they remain manual-review/no-finance-write evidence.
  - Source drift: the fresh PatientStats extraction drifted by `-400.00` versus the earlier live proof for total `Balance`, `TreatmentBalance`, and `PrivateBalance`.
  - Safety: R4 access was SELECT-only for patient import/mapping generation; no R4 writes occurred; default/main `dental_pms` was not touched; scratch finance table counts remained `invoices=0`, `payments=0`, `patient_ledger_entries=0`; no finance records were created or changed.
  - Scratch mapping stack cleanup is complete: containers and volumes for `dentalpms-obmap-20260505-082233` were removed, artefacts were preserved, and the default `dental-pms` stack remained untouched.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-05: PR #607 merged on `master` as backend-only, proof-report-only, no-write opening-balance dry-run/report tooling.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/opening_balance_snapshot_dry_run.py`
    - added `backend/app/scripts/r4_opening_balance_snapshot_dry_run.py`
    - added `backend/tests/r4_import/test_opening_balance_snapshot_dry_run.py`
  - Input/source modes: in-memory rows for tests, `PatientStats` JSON, and patient mapping JSON. No R4 source mode exists, no DB source/write path exists, and no apply mode exists.
  - Report sections: `generated_at`, `dry_run`, `select_only`, `source_summary`, `mapping_summary`, `eligibility_summary`, `sign_summary`, `component_consistency_summary`, `aged_debt_summary`, `refusal_reasons`, `samples`, `risks`, `manifest`, and `import_ready=false`.
  - Safety gates: no apply mode, no DB session/write path, no R4 source mode, manifest `no_write=true`, and `apply_mode=false`.
  - Report behaviour: summarizes supplied mappings, mapped and unmapped non-zero candidates, mapping coverage, eligibility/refusal decisions, raw signs, proof-only PMS directions, component pass/mismatch counts, and aged-debt metadata.
  - Validation: Docker pytest passed for `tests/r4_import/test_opening_balance_snapshot_dry_run.py`, `tests/r4_import/test_opening_balance_snapshot_plan.py`, and `tests/r4_import/test_r4_opening_balance_reconciliation.py` (`38 passed`); GitHub CI passed for backend, frontend, docker-build, recalls-api, playwright-parity, and playwright-smoke.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
  - Current continuity: scratch mapping stack cleanup is complete; PR #611's guarded apply design and PR #612's planning/preflight helper proof are now merged; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-05: Scratch-only opening-balance dry-run/report design recorded as docs/design-only.
  - Design doc: `docs/r4/R4_FINANCE_OPENING_BALANCE_SCRATCH_DRYRUN_DESIGN.md`
  - Purpose: define how a future report-only phase should run the PR #604 pure `PatientStats` planning helper against opening-balance source evidence and scratch patient mapping evidence before any write/apply path.
  - Data inputs: `PatientStats` from a preserved SELECT-only artefact or future SELECT-only R4 query, plus scratch patient mappings or mapping artefact; all `1018` non-zero-balance candidates must map for dry-run success, while the `15994` zero-balance rows remain no-op and mapping-visible.
  - Safety gates: scratch/test DB only if DB mapping reads are used, default/live DB refusal before session creation, explicit dry-run mode, no apply command, no finance writes, no ledger rows, no balance mutation, no invoice/payment creation, source artefact or SELECT-only run manifest required, and R4 read-only guard if R4 is queried.
  - Expected report: JSON/stdout/stderr/exit-code artefacts with `generated_at`, `dry_run=true`, source summary, patient mapping summary, eligibility summary, sign summary, component consistency summary, aged-debt summary, refusal reasons, samples, risks, manifest, and `import_ready=false`.
  - Recommended next slice: superseded by PR #607's merged backend-only dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof; guarded scratch apply CLI design/prototype should start only after explicit instruction.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; finance import remains out of scope.
- 2026-05-05: PR #604 merged on `master` as backend-only, pure-helper/test-only opening-balance snapshot plan helper proof.
  - Exact slice implemented:
  ...
  - The helper converts the opening-balance snapshot design into deterministic plan decisions for row-like `PatientStats` data plus supplied patient mapping, without DB access or importer wiring.
  - Decisions implemented: `eligible_opening_balance`, `no_op_zero_balance`, `missing_patient_mapping`, `invalid_patient_code`, `component_mismatch`, `invalid_amount`, `ambiguous_sign`, `manual_review`, and `excluded`.
  - Eligibility: non-zero `PatientStats` rows require valid `PatientCode`, patient mapping, exact pence conversion, passing component checks, and clear sign. Zero-balance rows remain no-op and can no-op without mapping.
  - Sign and safety: raw R4 signs are preserved; positive balances are proof-only `increase_debt`, negative balances are proof-only `decrease_debt_or_credit`, zero balances are `no_action`, and no sign inversion is allowed.
  - Fail-closed coverage includes missing `PatientCode`, missing mapping, component mismatch, invalid/non-pence amount, explicit sign conflict, and unsupported source.
  - Safety: importer behaviour remained unchanged; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed; no PMS DB writes occurred; no R4 access or writes occurred.
  - Validation: py_compile passed; Docker pytest passed for the new helper tests plus finance classification, opening balance reconciliation, and finance inventory tests (`49 passed`); GitHub CI passed after rerunning an unrelated `playwright-smoke` failure.
  - Import-readiness: `finance_import_ready=false`; superseded by PR #607's merged backend-only dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: Opening-balance snapshot import design recorded as docs/design-only.
  - Design doc: `docs/r4/R4_FINANCE_OPENING_BALANCE_SNAPSHOT_DESIGN.md`
  - Source decision: `PatientStats` is the candidate opening-balance snapshot source; it is a balance snapshot, not row-level invoice/payment truth.
  - Snapshot semantics: future financial effect should use combined `PatientStats.Balance` only; treatment/sundry/NHS/private/DPB components and aged debt are preserved as manifest metadata/reconciliation evidence, not separate PMS ledger rows.
  - Sign policy: preserve raw R4 signs; positive balances are proof-only PMS debt increases, negative balances are proof-only debt decreases/credits, zero balances are no-op; no blind sign inversion is allowed.
  - Eligibility: future proof candidates are non-zero `PatientStats` rows with mapped patients, valid pence conversion, passed component checks, and unambiguous sign; `15994` zero rows remain no-op.
  - Future scratch proof recommendation: PR #604 completed the pure opening-balance snapshot plan helper, the scratch-only opening-balance dry-run/report design is recorded above, PR #607 completed the backend-only dry-run/report tooling, the scratch-only dry-run execution evidence is complete, the scratch mapping stack cleanup is complete, PR #611 recorded the guarded scratch-only apply design, and PR #612 completed the planning/preflight helper proof. Guarded scratch apply CLI design/prototype should start only after explicit instruction, before any scratch apply or finance import.
  - Safety: no R4 access occurred; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Import-readiness: `finance_import_ready=false`; superseded by PR #607's merged backend-only dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: Finance invoice/charge-ref source decision recorded after live cash-event staging proof.
  - Decision doc: `docs/r4/R4_FINANCE_INVOICE_CHARGE_REF_SOURCE_DECISION.md`
  - Evidence inspected: finance inventory, live opening balance proof, live cancellation/refund/allocation proof, live cash-event staging proof, finance policy docs, and current finance proof scripts/helpers.
  - Live SELECT-only metadata/source-discovery check used `INFORMATION_SCHEMA` table/view and column searches plus targeted aggregate counts for suspected finance sources. No broad row dumps were performed.
  - Result: no explicit R4 patient invoice or statement source was found; `Clinics.SMSInvoiceNumber` remains the only invoice-like field and is not patient invoice truth.
  - Allocation result: `PaymentAllocations` and `vwAllocatedPayments` each had `3130` rows and linked `PaymentID=3130`, but `ChargeTransactionRefID=0` and `ChargeAdjustmentRefID=0`; invoice application remains blocked.
  - Transactions result: `Transactions` remains treatment/charge evidence and reconciliation input, not invoice truth; current aggregate evidence still has `PaymentAdjustmentID` non-zero `0`.
  - Import-readiness: `finance_import_ready=false`; no finance import, finance staging models, invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Safety: R4 access was SELECT-only for metadata/aggregate discovery; no R4 writes occurred; no PMS DB writes occurred.
  - Current continuity: scratch mapping stack cleanup is complete, PR #611's guarded apply design and PR #612's planning/preflight helper proof are now merged, and finance import remains out of scope pending explicit instruction for a guarded scratch apply CLI design/prototype.
- 2026-05-04: Live SELECT-only finance cash-event staging proof completed with no tracked repo changes.
  - Evidence path: `/home/amir/dental-pms-finance-cash-event-live-proof/.run/finance_cash_event_staging_20260504_191704/`
  - Key artefact: `finance_cash_event_staging.json`; command exit `0`, JSON valid, `stderr.log` empty, and `select_only=true`.
  - Candidate population: `vwPayments` rows `44906`, `Adjustments` rows `47732`, eligible cash-event candidates `42914`, manual-review rows `47794`, excluded rows `0`, cancellation/reversal rows `1930`, payment candidates `36859`, refund candidates `104`, credit candidates `5951`, and missing patient/date/amount/zero amount counts `0`.
  - Cancellation pairing: `Adjustments CancellationOf=460`, paired originals `460`, missing originals `0`, patient mismatches `0`, date-order risk `0`, paired net amount `0.00`.
  - Refund handling: `vwPayments` refunds `110`, refund total `18563.48`, refund candidates `104`, allocation refunds `795`, matching allocation refunds `62`, allocation refunds without `vwPayments` refund `733`, and `vwPayments` refunds without allocation `48`.
  - Credit/method/sign proof: `vwPayments` credits `6513`, credit total `-1330109.00`, credit candidates `5951`, advanced payment allocations `2335`; proof-only method families were cash `25678`, cheque `10928`, card `6946`, credit/overpayment `1344`, and other/unknown `10`; classification rows were candidate `42914` and manual-review `49724`, raw signs negative `88880` and positive `3758`, proof-only PMS directions decrease debt `42810` and increase debt `104`.
  - Import-readiness gate: `finance_import_ready=false`; blockers include unresolved allocation refunds, absent charge refs, proof-only payment method mapping, cancelled rows outside proven pairs, and no explicit invoice/statement/charge-ref source.
  - Safety: R4 access was SELECT-only; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Superseded by the invoice/charge-ref source decision, opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, PR #607's merged dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof recorded above; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: PR #599 merged on `master` as backend-only, SELECT-only cash-event staging proof/report tooling.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/finance_cash_event_staging.py`
    - added `backend/app/scripts/r4_finance_cash_event_staging.py`
    - added `backend/tests/r4_import/test_r4_finance_cash_event_staging.py`
  - The tooling reports candidate cash-event population, cancellation pairing, refund handling, credit handling, payment type mapping, classification/sign summary, import-readiness gates, risks, and bounded samples from `vwPayments` plus `Adjustments`.
  - Superseded by the live SELECT-only cash-event staging proof evidence recorded above.
  - Safety: no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed; no PMS DB writes occurred; no R4 access or writes occurred.
  - Finance import-readiness remains blocked by refund/allocation mismatch, missing allocation charge refs, payment/refund semantics risk, proof-only payment method mapping, and no explicit invoice/statement/charge-ref source.
  - Superseded by the invoice/charge-ref source decision, opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, PR #607's merged dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof recorded above; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: Refund-allocation/charge-ref semantics decision recorded as docs/design-only in `docs/r4/R4_FINANCE_REFUND_ALLOCATION_CHARGE_REF_DECISION.md`.
  - Decision: `Adjustments.CancellationOf` pairing is reliable for the current `460` paired rows and should be reversal metadata or exclusion evidence, not independent import rows.
  - Decision: `vwPayments` plus `Adjustments` are the safest future payment/refund/credit cash-event proof sources; `PaymentAllocations` and `vwAllocatedPayments` remain reconciliation-only.
  - Decision: allocation rows cannot apply payments to PMS invoices because charge refs are `0` and missing charge refs are `3130`.
  - Decision: `vwPayments` credits are proof candidates, while advanced payment allocations remain reconciliation-only until their relationship to credits and balances is proven.
  - Safety: no backend/importer/runtime behaviour changed; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed; no PMS DB writes occurred; no R4 access or writes occurred.
  - Superseded by PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, PR #607's merged dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof recorded above; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: PR #596 merged on `master` as backend-only, SELECT-only cancellation/refund/allocation reconciliation proof tooling, with live SELECT-only evidence recorded.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/finance_cancellation_allocation_reconciliation.py`
    - added `backend/app/scripts/r4_finance_cancellation_allocation_reconciliation.py`
    - added `backend/tests/r4_import/test_r4_finance_cancellation_allocation_reconciliation.py`
  - Evidence path: `/home/amir/dental-pms-finance-cancellation-allocation-proof/.run/finance_cancellation_allocation_reconciliation_20260504_140810/`
  - Key artefact: `finance_cancellation_allocation_reconciliation.json`; `select_only=true`, command exit `0`, and `stderr.log` empty.
  - Cancellation pairing: `vwPayments` cancelled rows `1032`, cancelled total `-90633.58`; `Adjustments CancellationOf=460`, originals found `460`, originals missing `0`, patient mismatches `0`, paired net amount `0.00`. Paired `Adjustments` cancellations net to zero within tolerance, but cancellation rows remain manual-review/excluded under policy until import readiness is proven.
  - Refund/allocation mismatch: `vwPayments` refunds `110`, refund total `18563.48`; `PaymentAllocations` refunds `795`, refund total `-53401.40`; matching allocation refunds `62`, allocation refunds without `vwPayments` refund `733`, and `vwPayments` refunds without allocation `48`.
  - Advanced payment / credit / allocation: advanced payment allocations `2335`, `vwPayments` credits `6513`, linked allocations `3130`, charge refs `0`, missing charge refs `3130`.
  - Classification/sign samples: allocation reconciliation `20`, cancellation/reversal `5`, refund candidate `10`, credit candidate `5`, manual review `5`.
  - Safety: R4 access was SELECT-only; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Superseded by the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, PR #607's merged dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof recorded above; guarded scratch apply CLI design/prototype should start only after explicit instruction.
- 2026-05-04: Live SELECT-only opening balance reconciliation proof completed with no tracked repo changes.
  - Evidence path: `/home/amir/dental-pms-opening-balance-live-proof/.run/opening_balance_reconciliation_20260504_083558/`
  - Key artefact: `opening_balance_reconciliation.json`; command exit `0`, JSON valid, `stderr.log` empty, `select_only=true`.
  - PatientStats component consistency: `row_count=17012`, `nonzero_balance_count=1018`, null/blank PatientCode `0`, total Balance `-131342.13`, TreatmentBalance `-139692.13`, SundriesBalance `8350.00`, NHSBalance `2724.60`, PrivateBalance `-142416.73`, DPBBalance `0.00`; Balance matched TreatmentBalance + SundriesBalance with `0` mismatches, and TreatmentBalance matched NHS + Private + DPB with `0` mismatches.
  - Aged debt: total `10329.82`, rows with aged debt `126`, aged debt with zero balance `0`, balance without aged debt `892`; aged debt did not reconcile directly to total balance or positive debt total.
  - Linkage/sign proof: PatientCode present `17012`, blank/null `0`, distinct PatientCodes `17012`; balance snapshot candidates `1018`, excluded zero/no-action rows `15994`, manual review `0`; raw signs positive `291`, negative `727`, zero `15994`, unknown `0`; proof-only PMS directions increase debt `291`, decrease debt `727`, no change `15994`.
  - Cross-source indicators remained aggregate-only: `vwPayments` rows `44906`, total `-4421051.59`, refunds `110`, credits `6513`, cancellations `1032`; `Adjustments` rows `47731`, total `-4975508.73`, `CancellationOf=460`; `Transactions` rows `516218`, PatientCost `4844211.68`, DPBCost `77933.64`, PaymentAdjustmentID `0`; `PaymentAllocations`/`vwAllocatedPayments` rows `3130`, total_cost `11714.03`, refunds `795`, advanced payments `2335`, charge refs `0`.
  - Safety: R4 access was SELECT-only; no R4 writes occurred; no PMS DB writes occurred; no finance records were created or changed.
  - Next finance slice: cancellation pairing/refund-allocation mismatch proof.
- 2026-05-04: PR #593 merged on `master` as backend-only, SELECT-only opening balance reconciliation command/report tooling.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/opening_balance_reconciliation.py`
    - added `backend/app/scripts/r4_opening_balance_reconciliation.py`
    - added `backend/tests/r4_import/test_r4_opening_balance_reconciliation.py`
  - The tooling reports PatientStats component consistency, aged debt consistency, patient linkage, classification/sign summary, and cross-source aggregate indicators through JSON/stdout output.
  - Live SELECT-only opening balance proof evidence remains pending because complete R4 env was not available during implementation.
  - Safety: no finance import/staging models were added; no invoices, payments, balances, or finance records were created or changed; no PMS DB writes occurred; no R4 access or writes occurred.
  - Superseded by the live SELECT-only opening balance proof evidence, PR #596 cancellation/refund/allocation proof evidence, the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, PR #604 plan helper proof, scratch dry-run/report design, PR #607's merged dry-run/report tooling, scratch-only dry-run execution evidence, stack cleanup, PR #611's guarded apply design, and PR #612's planning/preflight helper proof recorded above; guarded scratch apply CLI design/prototype should start only after explicit instruction.
...
- 2026-05-03: PR #584 merged on `master` as scratch-only guarded core-promotion CLI/prototype, followed by scratch evidence capture.
  - Exact slice implemented:
    ...
    - updated `backend/app/services/r4_import/appointment_core_promotion_apply.py`
    - updated `backend/tests/r4_import/test_appointment_core_promotion_apply.py`
    - added `backend/tests/r4_import/test_appointment_core_promotion_apply_cli.py`
    - added `docs/r4/R4_APPOINTMENT_CORE_PROMOTION_SCRATCH_RUNBOOK.md`
  - Evidence path: `/home/amir/dental-pms-appointment-core-promotion-scratch/.run/appointment_core_promotion_dentalpms_appt_core_apply_20260503_154718/`
  - Scratch target: Compose project `dentalpms_appt_core_apply_20260503_154718`, DB `dental_pms_appointment_core_promotion_scratch`, Postgres port `5554`, backend port `8214`; frontend port `3214` was reserved but not started.
  - Current R4 source drift note: this transcript used `101057` appointment rows and `63` future rows, compared with the earlier no-core-write dry-run evidence of `101051` rows, `57` future rows, and `94156` promote candidates.
  - Apply result: core `appointments` went from `0` to `94162`; created `94162`, updated `0`, skipped `0`.
...
- 2026-05-03: PR #582 merged on `master` as backend-only, no-DB-write guarded core-promotion apply-plan prototype.
  - Exact slice implemented:
    ...
    - added `backend/tests/r4_import/test_appointment_core_promotion_apply.py`
...
- 2026-05-03: PR #580 merged on `master` as backend-only, pure-helper/test-only appointment conflict predicate proof.
  - Exact slice implemented:
    ...
    - added `backend/tests/appointments/test_appointment_conflict_predicate.py`
  - The helper proves same-clinician overlap semantics for future guarded apply work: `booked`, `arrived`, `in_progress`, and `completed` block; `cancelled`, `no_show`, and soft-deleted existing appointments do not block; exact same and partial overlaps conflict; back-to-back intervals do not conflict; missing/different clinician does not conflict; patient identity is irrelevant; aware datetimes compare by instant; and missing/naive/invalid datetimes or missing/unknown existing statuses fail closed.
  - Route behaviour remains unchanged: the create route still allows overlaps by existing behaviour, and update route behaviour was not refactored in this slice.
  - No R4 promotion/apply/import wiring, core appointment apply/promotion, PMS DB write, or R4 access occurred.
  - Next implementation slice is guarded core-promotion apply design/prototype in scratch only.
- 2026-05-03: PR #578 merged on `master` as backend-only, pure-helper/test-only appointment timezone/local-time proof.
  - Exact slice implemented:
    - added `backend/app/services/r4_import/appointment_datetime_policy.py`
    - added `backend/tests/r4_import/test_appointment_datetime_policy.py`
  - The helper interprets naive R4 appointment datetimes as Europe/London clinic-local wall times, converts valid local times to UTC-aware datetimes for future PMS core diary storage, and fails closed for invalid, missing, ambiguous fall-back, or non-existent spring-forward local times.
  - Importer and promotion behaviour remain unchanged; no conflict predicate extraction, core appointment apply/promotion, PMS DB write, or R4 access occurred in the slice.
  - Superseded by PR #580's conflict predicate proof; next implementation slice is guarded core-promotion apply design/prototype in scratch only.
- 2026-04-30: PR #576 merged on `master` as backend-only, pure-helper/test-only appointment promotion plan proof.
  ...
  - Superseded by PR #578's timezone/local-time proof and PR #580's conflict predicate proof; next implementation slice is guarded core-promotion apply design/prototype in scratch only.
- 2026-04-30: PR #574 merged on `master` as backend-only/report-only no-core-write appointment promotion dry-run tooling, followed by scratch evidence capture.
  - Exact slice implemented:
    ...
    - added `backend/app/scripts/r4_appointment_promotion_dryrun.py`
    - added `backend/tests/r4_import/test_appointment_promotion_dryrun.py`
  - Evidence path: `/home/amir/dental-pms-appointment-promotion-dryrun/.run/appointment_promotion_dryrun_dentalpms_appt_promo_dryrun_20260430_0835/`
  - Scratch target: Compose project `dentalpms_appt_promo_dryrun_20260430_0835`, DB `dental_pms_appointment_promotion_scratch`.
  - Safety: R4 access was SELECT-only, no R4 writes occurred, PMS writes were scratch-only, no core appointment writes occurred, and core `appointments` remained unchanged with `before=0` and `after=0`.
  ...
  - The promotion dry-run scratch stack was cleaned up after evidence capture; superseded by PR #576's promotion plan helper/proof, PR #578's timezone/local-time proof, and PR #580's conflict predicate proof, so the next readiness step is guarded core-promotion apply design/prototype in scratch only.
- 2026-04-30: Isolated scratch appointment import/idempotency/linkage transcript completed with no tracked repo changes.
  ...
  - Safety: R4 access was SELECT-only, no R4 writes occurred, PMS writes were scratch-only, and core `appointments` remained `0`.
  ...
  - Superseded by PR #574's no-core-write appointment promotion dry-run/report, PR #576's promotion plan helper/proof, PR #578's timezone/local-time proof, and PR #580's conflict predicate proof; next readiness step is guarded core-promotion apply design/prototype in scratch only.
- 2026-04-30: PR #571 merged on `master` as backend-only, pure-helper/test-only appointment status-mapping proof.
  - Exact slice implemented:
    ...
    - added `backend/tests/r4_import/test_appointment_status_policy.py`
  ...
  - Superseded by the isolated scratch appointment import/idempotency/linkage transcript, PR #574's no-core-write appointment promotion dry-run/report, PR #576's promotion plan helper/proof, PR #578's timezone/local-time proof, and PR #580's conflict predicate proof recorded above; next readiness step is guarded core-promotion apply design/prototype in scratch only.
- 2026-04-29: Live SELECT-only appointment cutover inventory completed against R4 with no R4 writes, no PMS DB writes, and no tracked repo changes.
  ...
  - Follow-up policy is documented in `docs/r4/R4_APPOINTMENT_STATUS_POLICY.md`; subsequent appointment readiness evidence now includes PR #571's backend helper/proof, the scratch import/idempotency/linkage transcript, PR #574's promotion dry-run/report, PR #576's promotion plan helper/proof, and PR #578's timezone/local-time proof.
...
- 2026-04-27: PR #555 merged on `master` as a backend-only/proof-only `appointment_notes` scale-out continuation.
  - Exact slice implemented:
    - added `backend/tests/r4_import/test_appointment_notes_scaleout_proof.py`
    - extended deterministic appointment-note scale-out confidence using the existing cohort/import/parity path without changing production code
    - kept the slice out of frontend, runtime, Docker, compose, ops, docs, unrelated domains, appointment cutover work, and live R4 access
  - Next implementation slice should remain aligned with `docs/R4_MIGRATION_READINESS.md`.
- 2026-04-27: PR #554 merged on `master` as a docs-only continuity refresh after PR #553.
- 2026-04-27: PR #553 merged on `master` as a backend-only/proof-only combined scale-out proof for `completed_questionnaire_notes` and `old_patient_notes`.
  - Exact slice implemented:
    - added `backend/tests/r4_import/test_cqn_old_patient_notes_scaleout_proof.py`
    - proved the two domains together through deterministic cohort selection, batched `charting_canonical` import wiring, and consolidated parity over a simulated 20-patient cohort
    - kept the slice out of frontend, runtime, Docker, compose, ops, docs, unrelated domains, and live R4 access
  - Next implementation slice should remain aligned with `docs/R4_MIGRATION_READINESS.md`.
- 2026-04-27: PR #552 merged on `master` as a docs-only continuity refresh after PR #551.
...
- 2026-04-27: PR #548 merged on `master` to complete backend-only deterministic `r4_cohort_select` support for `completed_questionnaire_notes` without widening into frontend, runtime, Docker, compose, ops, docs, or R4 write paths.
  - Exact slice implemented:
    ...
    - registered `completed_questionnaire_notes` in `r4_cohort_select`
    - added focused cohort-selector and completed-questionnaire SQL extraction tests
- 2026-04-27: PR #547 merged on `master` as a one-file docs-only continuity refresh so `docs/STATUS.md` matched the real post-PR-#546 baseline.
...
- 2026-04-21: PR #540 merged on `master` as a docs-only alignment slice so `docs/STATUS.md` and `docs/V1_FINISH_LINE.md` matched the real current master baseline and accepted appointment-conflict wording.
...
## Next up
- No active implementation slice is selected on current master. Choose the next smallest truthful slice from `master@2cf51a2`, keeping any preserved local operational diffs separate from product development.
