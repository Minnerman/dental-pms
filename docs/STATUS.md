...
- 2026-05-05: PR #604 merged on `master` as backend-only, pure-helper/test-only opening-balance snapshot plan helper proof.
  ...
  - Import-readiness: `finance_import_ready=false`; next finance slice is scratch-only opening-balance dry-run/report design before any finance import.
- 2026-05-04: Opening-balance snapshot import design recorded as docs/design-only.
  ...
  - Future scratch proof recommendation: PR #604 has now completed the pure opening-balance snapshot plan helper; the next step is scratch-only opening-balance dry-run/report design before any scratch apply or finance import.
  ...
  - Import-readiness: `finance_import_ready=false`; superseded by PR #604's pure opening-balance snapshot plan helper proof; next finance slice is scratch-only opening-balance dry-run/report design.
- 2026-05-04: Finance invoice/charge-ref source decision recorded after live cash-event staging proof.
  ...
  - Next finance slice: scratch-only opening-balance dry-run/report design before any finance import.
- 2026-05-04: Live SELECT-only finance cash-event staging proof completed with no tracked repo changes.
  ...
  - Superseded by the invoice/charge-ref source decision, opening-balance snapshot design, and PR #604 plan helper proof recorded above; next finance slice is scratch-only opening-balance dry-run/report design before any finance import.
...
- 2026-05-04: Refund-allocation/charge-ref semantics decision recorded as docs/design-only in `docs/r4/R4_FINANCE_REFUND_ALLOCATION_CHARGE_REF_DECISION.md`.
  ...
  - Superseded by PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, and PR #604 plan helper proof recorded above; next finance slice is scratch-only opening-balance dry-run/report design before any finance import.
- 2026-05-04: PR #596 merged on `master` as backend-only, SELECT-only cancellation/refund/allocation reconciliation proof tooling, with live SELECT-only evidence recorded.
  ...
  - Safety: R4 access was SELECT-only; no R4 writes occurred; no PMS DB writes occurred; no finance import/staging model was added; no invoices, payments, balances, ledger rows, or finance records were created or changed.
  - Superseded by the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, and PR #604 plan helper proof recorded above; next finance slice is scratch-only opening-balance dry-run/report design before any finance import.
...
- 2026-05-04: PR #593 merged on `master` as backend-only, SELECT-only opening balance reconciliation command/report tooling.
  ...
  - Superseded by the live SELECT-only opening balance proof evidence, PR #596 cancellation/refund/allocation proof evidence, the refund-allocation/charge-ref semantics decision, PR #599's merged SELECT-only cash-event staging proof tooling, the live cash-event proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, and PR #604 plan helper proof recorded above; next finance slice is scratch-only opening-balance dry-run/report design before any finance import.
