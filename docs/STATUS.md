...
- The R4 finance track has completed source discovery, live SELECT-only inventory, fail-closed sign/cancellation/allocation policy, backend-only pure classification/sign helper proof, backend-only SELECT-only opening balance reconciliation command/report tooling, live SELECT-only opening balance proof evidence, live SELECT-only cancellation/allocation proof evidence, the refund-allocation/charge-ref semantics decision, backend-only SELECT-only cash-event staging proof tooling, live SELECT-only cash-event staging proof evidence, the invoice/charge-ref source decision, the opening-balance snapshot design, the backend-only pure opening-balance snapshot plan helper proof, the scratch-only opening-balance dry-run/report design, PR #607's backend-only opening-balance dry-run/report tooling, scratch-only opening-balance dry-run execution evidence, scratch mapping stack cleanup, the guarded scratch-only opening-balance apply design, PR #612's backend-only guarded scratch apply planning/preflight helper proof, PR #614's guarded scratch-only apply CLI prototype, PR #615's bounded synthetic scratch execution proof, PR #616's preserved-evidence scratch execution plan, PR #617's execution package decision, PR #618's bounded fixture package, PR #619's bounded fixture approval record, PR #620's bounded fixture execution-readiness verification, PR #621's validation/no-write evidence, PR #622's owner sign-off for that no-write evidence, PR #623's guarded apply/write readiness check, and PR #624's first local isolated scratch/test-only bounded fixture guarded apply/idempotency proof. PR #587's inventory evidence path is `/home/amir/dental-pms-finance-inventory-proof/.run/finance_inventory_20260503_201724/`; opening balance evidence path is `/home/amir/dental-pms-opening-balance-live-proof/.run/opening_balance_reconciliation_20260504_083558/`; cancellation/allocation evidence path is `/home/amir/dental-pms-finance-cancellation-allocation-proof/.run/finance_cancellation_allocation_reconciliation_20260504_140810/`; the refund-allocation/charge-ref semantics decision is recorded in `docs/r4/R4_FINANCE_REFUND_ALLOCATION_CHARGE_REF_DECISION.md`; cash-event staging evidence path is `/home/amir/dental-pms-finance-cash-event-live-proof/.run/finance_cash_event_staging_20260504_191704/`; the invoice/charge-ref source decision is recorded in `docs/r4/R4_FINANCE_INVOICE_CHARGE_REF_SOURCE_DECISION.md`; the opening-balance snapshot design is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_SNAPSHOT_DESIGN.md`; the scratch dry-run/report design is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_SCRATCH_DRYRUN_DESIGN.md`; guarded apply design and prototype limits are recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_GUARDED_APPLY_DESIGN.md`; synthetic proof scope is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_SYNTHETIC_SCRATCH_PROOF.md`; preserved-evidence scratch execution planning is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_PRESERVED_EVIDENCE_SCRATCH_EXECUTION_PLAN.md`; execution package decision is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_EXECUTION_PACKAGE_DECISION.md`; bounded fixture package is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_PACKAGE.md`; bounded fixture owner approval is recorded in `docs/r4/fixtures/opening_balance_bounded_fixture/APPROVAL_RECORD_20260507.md`; bounded fixture execution-readiness is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_EXECUTION_READINESS.md`; bounded fixture validation/no-write evidence is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_VALIDATION_NOWRITE_EVIDENCE.md`; bounded fixture validation/no-write sign-off is recorded in `docs/r4/fixtures/opening_balance_bounded_fixture/VALIDATION_NOWRITE_SIGNOFF_20260508.md`; bounded fixture guarded apply proof evidence is recorded in `docs/r4/R4_FINANCE_OPENING_BALANCE_BOUNDED_FIXTURE_GUARDED_APPLY_EVIDENCE.md`; bounded fixture guarded apply proof evidence sign-off is recorded in `docs/r4/fixtures/opening_balance_bounded_fixture/GUARDED_APPLY_EVIDENCE_SIGNOFF_20260508.md`; scratch-only dry-run execution artefacts are preserved in `/home/amir/dental-pms-opening-balance-dryrun-execution/.run/opening_balance_snapshot_dryrun_mapping_20260505_082233/`. `finance_import_ready=false`; no further guarded apply/write, live/default finance writes, full eligible-row artefact execution, or finance import are authorised by this branch.
