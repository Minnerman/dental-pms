...
from app.scripts import r4_completed_questionnaire_notes_parity_pack as pack
        ...
        def list_completed_questionnaire_notes(self, **_kwargs):
            return [
                ...
                R4CompletedQuestionnaireNote(
                    ...
                    source_row_id=21,
                    note="   ",
                    completed_at=datetime(2025, 1, 2, 10, 0, 0),
                ),
                R4CompletedQuestionnaireNote(
                    patient_code=1001,
                    source_row_id=20,
                    note="dup source row",
                    completed_at=datetime(2025, 1, 2, 11, 0, 0),
                ),
                R4CompletedQuestionnaireNote(
                    patient_code=1001,
                    source_row_id=22,
