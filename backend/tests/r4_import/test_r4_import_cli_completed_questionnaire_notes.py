...
def test_parse_charting_domains_accepts_completed_questionnaire_notes():
    assert r4_import_script._parse_charting_domains_arg("completed_questionnaire_notes") == [
        "completed_questionnaire_notes"
    ]


def test_cli_charting_canonical_completed_questionnaire_notes_stats_shape(
    ...
    def fake_import(*_args, **kwargs):
        ...
        return DummyStats(), {
            ...
            "by_source": {"dbo.CompletedQuestionnaire": {"fetched": 4}},
            "stats": DummyStats().as_dict(),
            "dropped": {
                "blank_note": 3,
                "out_of_window": 2,
                "accepted_nonblank_note": 4,
                "accepted_blank_note": 3,
                "included": 4,
            },
        }
    ...
    assert captured["domains"] == ["completed_questionnaire_notes"]
